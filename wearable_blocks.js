...
//    this.appendDummyInput()
        ...
        var options = [
           ...
           [{'src': 'images/wink.png', 'width': 50, 'height': 50, 'alt': 'wink'}, '105'],
           [{'src': 'images/alligator.png', 'width': 50, 'height': 50, 'alt': 'alligator'}, '106'],
           [{'src': 'images/bird.png', 'width': 50, 'height': 50, 'alt': 'bird'}, '107'],
           [{'src': 'images/bug.png', 'width': 50, 'height': 50, 'alt': 'bug'}, '108'],
           [{'src': 'images/cat.png', 'width': 50, 'height': 50, 'alt': 'cat'}, '109'],
           [{'src': 'images/dog.png', 'width': 50, 'height': 50, 'alt': 'dog'}, '110'],
           [{'src': 'images/crab.png', 'width': 50, 'height': 50, 'alt': 'crab'}, '111'],
           [{'src': 'images/duck.png', 'width': 50, 'height': 50, 'alt': 'duck'}, '112'],
           [{'src': 'images/snake.png', 'width': 50, 'height': 50, 'alt': 'snake'}, '113'],
           [{'src': 'images/monster1.png', 'width': 50, 'height': 50, 'alt': 'monster1'}, '114'],
           [{'src': 'images/monster2.png', 'width': 50, 'height': 50, 'alt': 'monster2'}, '115'],
           [{'src': 'images/monster3.png', 'width': 50, 'height': 50, 'alt': 'monster3'}, '116'],
           [{'src': 'images/monster4.png', 'width': 50, 'height': 50, 'alt': 'monster4'}, '117'],
           [{'src': 'images/heart.png', 'width': 50, 'height': 50, 'alt': 'heart'}, '118'],
           [{'src': 'images/rainbow.png', 'width': 50, 'height': 50, 'alt': 'rainbow'}, '119'],
           [{'src': 'images/peace.png', 'width': 50, 'height': 50, 'alt': 'peace'}, '120'],
           [{'src': 'images/girl.png', 'width': 50, 'height': 50, 'alt': 'girl'}, '121'],
           [{'src': 'images/boy.png', 'width': 50, 'height': 50, 'alt': 'boy'}, '122'],
           [{'src': 'images/person.png', 'width': 50, 'height': 50, 'alt': 'person'}, '123'],
           [{'src': 'images/space_ship.png', 'width': 50, 'height': 50, 'alt': 'space_ship'}, '124'],
           [{'src': 'images/rocket.png', 'width': 50, 'height': 50, 'alt': 'rocket'}, '125'],
