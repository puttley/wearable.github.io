...
Blockly.JavaScript['matrix_row'] = function(block) {
  ...
  var colour_color = block.getFieldValue('color');
  var code = 238 + ',' + dropdown_row + ',' + pickycolor(colour_color) + ',';
  return code;
};
...
Blockly.JavaScript['exp_is'] = function(block) {
  var dropdown_is = block.getFieldValue('is');
...
Blockly.JavaScript['exp_tone'] = function(block) {
  ...
  number_hz = number_hz / 10;
  number_hz = number_hz.toFixed(0); // integer only
  // TODO: Assemble JavaScript into code variable.
